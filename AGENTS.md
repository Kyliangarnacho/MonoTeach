...
- OpenCV camera index is not a stable hardware identifier. Windows re-enumeration may change C920 index; before hardware validation, confirm the actual camera device/index and do not diagnose backend/resolution/code failure solely from a historical index.
