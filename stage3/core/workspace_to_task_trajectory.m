...
% retarget_task_to_robot; that adapter deliberately reuses this mapping.
    ...
    for i = 1:numel(sourceSamples)
        ...
        taskSamples(i).pen_state = sourceSample.pen_state;
        taskSamples(i).stroke_id = sourceSample.stroke_id;
    ...
    taskMetadata.task_semantics = taskSemantics;
